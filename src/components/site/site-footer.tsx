  ...
  return (
    <>
      ...
      <footer className="bg-brand-navy text-sky-200/80">
        <div className="mx-auto grid max-w-7xl gap-11 px-5 py-16 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          <div>
            <div className="mb-5 flex items-center gap-3">
              ...
              <span className="leading-none">
                ...
                <span className="mt-1 block text-[10px] font-bold uppercase tracking-[0.34em] text-sky-300/60">
                  Urgent Care
                </span>
              </span>
            </div>
            <p className="max-w-sm text-sm">
              A new, modern walk-in clinic for urgent, non-life-threatening
              illnesses and injuries — coming soon to Canarsie, Brooklyn, and
              serving the greater five boroughs through community outreach.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link className="hover:text-white hover:underline" href="/services">Planned Services</Link></li>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link className="hover:text-white hover:underline" href="/contact">
                  Stay connected for opening updates
                </Link>
              </li>
              <li>
        ...
        <div className="mx-auto max-w-7xl px-5">
          <div className="rounded-2xl border border-brand-orange/50 bg-brand-orange/10 px-5 py-4 text-sm text-[#ffd9a0]">
            ...
            Wellthrivea Urgent Care is for urgent, non-life-threatening
            illnesses and injuries. If you are experiencing a life-threatening
        ...
        <div className="mx-auto mt-7 max-w-7xl border-t border-white/10 px-5 py-8">
          ...
          <p className="mx-auto mb-2 max-w-5xl text-center text-xs leading-relaxed text-sky-300/60">
            Wellthrivea Urgent Care is preparing to open and is not yet seeing
            patients. Services, hours, staffing, and health-plan participation
            described on this site are planned and will be confirmed before
            opening. Content on this website is general information only — it
            is not medical advice, a diagnosis, or a substitute for
            individualized care from a licensed clinician. Health-plan
            participation and network status will be published and kept current
            once finalized; please confirm your coverage with your health plan
            before any visit.
          </p>
